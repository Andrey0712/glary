...
import { getShowListCacib } from "../../../actions/show";
...
const CacibPage = () => {
  ...
  const [cacib, setcacib] = useState(empty);
  ...
  const { list } = useSelector((state) => state.cacib);
