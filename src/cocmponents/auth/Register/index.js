      ...
      <div className="offset-md-3 col-md-5">
        ...
        >
          <Form>
            ...
            <TextInput label="Телефон" name="phone" id="phone" type="text" />

            <TextInput label="Прізвище" name="owner" id="owner" type="text" />

            <TextInput label="Адреса" name="address" id="address" type="text" />
